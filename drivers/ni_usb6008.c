			   ...
			   const struct usb_device_id *id)
{
	...
	printk(KERN_INFO "ni_usb6008: interface inf number %d", uinterf->cur_altsetting->desc.bInterfaceNumber);
	printk(KERN_INFO "ni_usb6008: interface alt settings %d", uinterf->cur_altsetting->desc.bAlternateSetting);
	printk(KERN_INFO "ni_usb6008: interface num nedpoints %d", uinterf->cur_altsetting->desc.bNumEndpoints);
	printk(KERN_INFO "ni_usb6008: interface if class %d", uinterf->cur_altsetting->desc.bInterfaceClass);
